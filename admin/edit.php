...
if($id){
    include("../connect.php");
    $sqlEdit = "SELECT * FROM historicalentries WHERE id = $id";
...
?>
        <div class="create-form w-100 mx-auto p-4" style="max-width:700px;">
            <form action="process.php" method="post">
                ...
                <div class="form-field mb-4">
                    <textarea name="region" class="form-control" id="" cols="30" rows="10" placeholder="Region:"><?php echo $data['region']; ?></textarea>
                </div>
